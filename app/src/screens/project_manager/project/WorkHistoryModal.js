...
import { getWorkHistoryByProjectId, approveWorkHour, disapproveWorkHour } from '../../../store/project';
...
const WorkHistoryModal = () => {
  ...
  const loadHours = async (cur_page = page) => {
    ...
    try {
      const newHours = await getWorkHistoryByProjectId(cur_page, projectId); // Fetch projects from the first page
      ...
      <View style={styles.container}>
        ...
        <View style={styles.modalView}>
            ...
            <SectionList
                ...
                keyExtractor={(item) => item._id.toString()} // Use the unique ID of each work hour as the key
                renderItem={renderItem}
                renderSectionHeader={renderHeader}
                onEndReached={() => { loadHours() }}
